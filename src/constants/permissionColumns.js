...
export const permissionColumns = [
    ...
    { field: 'originalPrice', renderHeader: () => <strong>Original Price</strong>, minWidth: 100, renderCell: (params) => params.value ?? "-"},
    { field: 'discountEndDate', renderHeader: () => <strong>Discount End Date</strong>, minWidth: 150, renderCell: (params) => params.value ?? "-"},
    { field: 'available', renderHeader: () => <strong>Available</strong>, minWidth: 70 },
    { field: 'offersIAP', renderHeader: () => <strong>Offers IAP</strong>, minWidth: 80 },
    ...
    { field: 'androidMaxVersion', renderHeader: () => <strong>Android Max Version</strong>, minWidth: 150 },
    ...
    { field: 'adSupported', renderHeader: () => <strong>Ad Supported</strong>, minWidth: 100 },
    { field: 'released', renderHeader: () => <strong>Released</strong>, minWidth: 100 },
